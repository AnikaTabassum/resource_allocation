...
class Resource_allocation:
    ...
    def forward_pass(self,all_activity):
        ...
        if cnt>1:
            ...
            all_activity=Resource_allocation().create_finish_node(finish_activities,all_activity)
        ...
        all_activity=Resource_allocation().bfs_forward_pass(visited, queue, sucs_dict, 'start', all_activity)
